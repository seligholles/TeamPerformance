...
insert TeamPerformance (Team, ObjectNumber, MonthlyRent, MonthRentedOut,  YearlyMaintenanceCost, YearlyLitigationExpenses, Waitingtime, Rating)

select          'Zurich',		1,	2000,	10,	    3100,	0,      '00:02:00',	5
union select    'Zurich',		2,	4000,	11,	    5000,	250,    null	,null
union select    'Zurich',		3,	2300,	11,	    7000,	2000,   '00:02:53',	3
union select    'Basel',		4,	3000,	8,	    2000,	200,    '00:01:00',	4
union select    'Basel',		5,	2700,	9,	    4000,	0,      null	,null
